...
import (
	...
	httpController "github.com/Alphonnse/yaxkcdro/internal/controller/http"
)
...
func (a *App) InitServiceProvider(pathConfig string) {
	...
	a.serviceProvider.RepositoryService()
	a.serviceProvider.APIUseCaseService()
...
func (a *App) initServer() {
	...
	a.server = &http.Server{
		Addr:    a.serviceProvider.ConfigService().ServerAddress(),
		Handler: a.mux,
	}
}

func (a *App) runServer() error {
	httpController.NewRouter(a.server, a.mux, a.serviceProvider.APIUseCaseService())
